...
cc_tool(
    name = "cl",
    src = "@{llvm_repo}//:cl_host{host}_target{target}",
    data = [
...
cc_tool(
    name = "link",
    src = "@{llvm_repo}//:link_host{host}_target{target}",
    data = [
        "@{llvm_repo}//:clang_all_binaries_host{host}_target{target}",
...
cc_tool(
    name = "lib",
    src = "@{llvm_repo}//:lib_host{host}_target{target}",
    data = [
        "@{llvm_repo}//:clang_all_binaries_host{host}_target{target}",
    ],
)
...
cc_tool(
    name = "ml64",
    src = "@{llvm_repo}//:ml64_host{host}_target{target}",
    data = [
        "@{llvm_repo}//:clang_all_binaries_host{host}_target{target}",
    ],
)
